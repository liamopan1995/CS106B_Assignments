...
# here what i ve seen in task 1:                                                     #
#1. runing in normal mode: the program window disappeared after cliking the go bottom.#
#2. runing in debugger mode:  index sequence show up as:  549 327 203 685 137.#
